...
<div class="frame">
    <div class="js-writeFrame">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div>
                <p><input type="text" name="writer" value="${login.userid}" readonly style="border: none;  background-color:#99ffff;"></p>
                <p>
                    <label><input type="checkbox" name="choice" value="feed" required> Feed</label>
